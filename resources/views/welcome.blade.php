...
<html lang="en">
  <head>
    ...
    <title>Short links, big results</title>
...
<section class="jumbotron text-left">
    <div class="container">
      <h1 class="large-8">Short links, big results</h1>
      <p class="lead text-muted">A URL shortener built with powerful tools to help you grow and protect your brand.</p>
